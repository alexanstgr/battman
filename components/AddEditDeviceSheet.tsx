...
const CATEGORIES: DeviceCategory[] = ['cameras', 'lights', 'audio', 'drones', 'other'];

const CATEGORY_ICONS: Record<DeviceCategory, (color: string) => React.ReactNode> = {
  ...
  drones: (c) => <MaterialCommunityIcons name="quadcopter" size={18} color={c} />,
      ...
      >
        ...
        <View style={[
          ...
          <View style={styles.field}>
            <Text style={[styles.label, { color: colors.mutedForeground }]}>{t.deviceNameLabel}</Text>
            <TextInput
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.catRow}>
              {CATEGORIES.map(cat => {
                ...
                return (
                  ...
                  >
                    {CATEGORY_ICONS[cat](isSelected ? colors.primary : colors.mutedForeground)}
                    <Text style={[styles.catText, { color: isSelected ? colors.primary : colors.mutedForeground }]}>
                      {categoryLabels[cat]}
                    </Text>
                  </TouchableOpacity>
                );
